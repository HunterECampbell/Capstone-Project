...
#####**Introduction**
*Pok&eacute;monGo* is an augmented reality game for handheld devices created by *Niantic, Inc.* Over 100 million downloads, and one of the most popular apps ever created. This report shows the correlation between Pok&eacute;mon spawn frequency and different environments that a *Pok&eacute;monGo* user might encounter. This report also presents data and graphical analysis that will affirm a rise in rare Pok&eacute;mon spawn rates and a drop in common Pok&eacute;mon spawn rates--- all based on location. This report will ultimately help all *Pok&eacute;monGo* users with their quest to "Catch'em All". Lets get started!
...
We can assume from the graphs that there is a correlation between when and where Pok&eacute;mon spawn and a *Pok&eacute;monGo* user's activity with the app. This would mean that *Pok&eacute;monGo* users usually play on the weekend, during good weather, in a common location, and/or during the night.
...
This returns about a 36.5% chance of seeing a water type Pok&eacute;mon near water. Now lets calculate the chance of seeing a non-water type Pok&eacute;mon near water:
...
This returns about a 20.4% chance of seeing a non-water type Pok&eacute;mon near water. That's a 16% difference! There is a 16% higher probability of finding a water type Pok&eacute;mon near water.
